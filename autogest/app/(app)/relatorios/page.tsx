...
export default function RelatoriosPage() {
  ...
  const tabLabel = tab === "dre" ? "DRE" : tab === "produtos" ? "Produtos" : "Vendedores"
  ...
  return (
    <div className="p-6">
      ...
      {/* Filtro de período */}
      <div className="flex items-center gap-3 mb-6 bg-white border border-gray-200 rounded-lg p-3 no-print">
